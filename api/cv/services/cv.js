...
const CLOSE_FILL_INFO_GRADE6 = "18/06/2021 00:00:01";
const CLOSE_CREATE_DOCUMENT_GRADE6 = "18/06/2021 00:00:01";
const CLOSE_SUBMIT_DOCUMENT_GRADE6 = "18/06/2021 00:00:01";
const DISPLAY_EXAM_RESULT_GRADE6 = "18/06/2021 12:00:01";

const STUDY_RESULT_GRADE10 = "01/03/2021 00:00:00";
const CLOSE_FILL_INFO_GRADE10 = "23/06/2021 00:00:01"; //close
const CLOSE_FILL_EXAM_RESULT_GRADE10 = "23/06/2021 00:00:01"; //close
const CLOSE_CREATE_DOCUMENT_GRADE10 = "23/06/2021 00:00:01"; //close
const CLOSE_SUBMIT_DOCUMENT_GRADE10 = "23/06/2021 00:00:01"; //close
const ENTRY_EXAM_RESULT_GRADE10 = "23/06/2022 00:00:01"; //close
const DISPLAY_EXAM_RESULT_GRADE10 = "23/06/2022 00:00:01"; //close
...
module.exports = {
  ...
  startResetHourlySMS: async () => {
    resetHourlySMSTask = cron.schedule("0 */1 * * *", () => {
      clearUserHourlyLimitOTP();
    });
    resetHourlySMSTask.start();
    console.log("Start reset hourly sms successfully!");
  },
